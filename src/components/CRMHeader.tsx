      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 top-full mt-1 w-48 py-2 bg-surface border border-border rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
            <Link href="/leads/new" className="flex items-center gap-2 px-4 py-2 text-sm text-grey hover:text-white hover:bg-white/5">
              <span>➕</span> New Lead
            </Link>
            <Link href="/tasks/new" className="flex items-center gap-2 px-4 py-2 text-sm text-grey hover:text-white hover:bg-white/5">
              <span>✓</span> New Task
            </Link>
            <Link href="/meetings/new" className="flex items-center gap-2 px-4 py-2 text-sm text-grey hover:text-white hover:bg-white/5">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 top-full mt-1 w-48 py-2 bg-surface border border-border rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
            ...
            <Link href="/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-grey hover:text-white hover:bg-white/5">
              Settings
            </Link>
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm text-grey hover:text-white hover:bg-white/5"
            >
              Back to Main Site ↗
            </a>
          </div>
