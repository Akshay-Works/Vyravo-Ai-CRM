...
export function DashboardContent() {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="space-y-3">
            {data?.recentLeads && data.recentLeads.length > 0 ? (
              ...
              <div className="text-center py-8 text-grey">
                ...
                <Link href="/leads/new" className="text-primary text-sm hover:underline mt-2 inline-block">
          ...
          <div className="space-y-3">
            {data?.upcomingMeetings && data.upcomingMeetings.length > 0 ? (
              ...
              <div className="text-center py-8 text-grey">
                ...
                <Link href="/meetings/new" className="text-primary text-sm hover:underline mt-2 inline-block">
                  Schedule a meeting →
                </Link>
              </div>
            )}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Add Lead", href: "/leads/new", icon: "👤" },
          { label: "Schedule Meeting", href: "/meetings/new", icon: "📅" },
          { label: "Create Task", href: "/tasks/new", icon: "✓" },
